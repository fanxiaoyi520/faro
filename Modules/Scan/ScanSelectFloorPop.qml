...
Popup {
    property var titleStr: SettingString.scan_select_floor
    property var list
    property var index: 0
    property int page: 0
    property var inputModelData
    property var unitInputModelData
    ...
    function accordingToUnitIdSearchFloor(index){
        ...
        http.post(Api.building_floor_page,
                  {"current":1,"size":2000,"unitId":unitInputModelData.id,"projectId":inputModelData.projectId,"blockId":inputModelData.id,"floorName":""})
    }
}
